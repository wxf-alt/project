package sparkstreaming.kafka_offset
...
object SparkStreamingKafkaOffsetNotAutoCommit {
  def main(args: Array[String]): Unit = {
    ...
    val kafkaParams = Map[String, Object](
      "bootstrap.servers" -> "s1.hadoop:9092,s2.hadoop:9092,s3.hadoop:9092,s4.hadoop:9092,s5.hadoop:9092,s6.hadoop:9092,s7.hadoop:9092,s8.hadoop:9092",
