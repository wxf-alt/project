 ...
 * @Description: 基于给定列的值进行筛选
 * @Version 1.0.0
 */
public class RegexStringComparatorFilterTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // 创建正则表达式
        RegexStringComparator rc = new RegexStringComparator("^赵");
        // 创建过滤器
        ...
        System.out.println("msg : The Data is queryed!");
        // 释放资源
        if(null != scanner){
            scanner.close();
        }
